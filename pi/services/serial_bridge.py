...
class SerialBridge:
    ...
    def _handle_distance(self, body: str) -> None:
        ...
        try:
            ...
            return
        # Closest valid reading — fusion only knows about a single number.
    ...
    def _handle_button(self, body: str) -> None:
        ...
        if down:
            ...
            # Firmware will follow up with AUDIO_END once it flushes; we just
            # note the button-up edge so the UI can show "release".
            pass
